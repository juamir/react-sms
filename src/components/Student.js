        ...
        axios.get('http://127.0.0.1:8000/students')
            .then(
                response => {
                    ...
                    props.setStudentList(response.data); //This is how you set data in your state variables
                }
    ...
    return (
        <div>
            <p>
                ...
                <button onClick={() => deleteStudent(props.student.id)} className="mx-2 btn btn-danger">X</button>
            </p>
        </div>
    );
}
